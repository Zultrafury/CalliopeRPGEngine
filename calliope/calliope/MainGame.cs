...
public class MainGame : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        var json = JsonConvert.SerializeObject(_sceneManager.Scenes["game"], Formatting.Indented, new JsonSerializerSettings()
        {
    ...
    void BuildMainMenuScene(string sceneName)
    {
        ...
        _menus["options"].Components[1].LinkedAction = new CommandMenuSwapTo(_menus["options"],_menus["main"],0);
